...
export default function PersonalInformation() {
    return (
        <div className="  w-full h-full z-50  overflow-y-auto  p-2">
            <div className="w-full lg:w-[900px] mx-auto p-4 bg-white">
                ...
                <div className="my-4 flex justify-between gap-2 items-center">
                    <div className='flex gap-2'>
                        <button className='bg-blue-500 rounded px-3 py-1 text-white cursor-pointer'>Save</button>
                        <button className='bg-gray-500 rounded px-3 py-1 text-white cursor-pointer'>Edit</button></div>
                    <div>
                        <button className='bg-blue-500 rounded px-3 py-1 text-white cursor-pointer'>Download</button>
