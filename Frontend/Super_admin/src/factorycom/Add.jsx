        ...
        <div className="w-full h-full overflow-y-auto lg:w-[900px] mx-auto p-2">
            ...
            <div className="flex items-center gap-2">
                <div className='space-y-2'>
                    <h1 className='py-1 px-3'>Basic Information</h1>
                    <div className='py-1 px-3'>Aadhar Card Image</div>
                    <div className='py-1 px-3'>Aadhar Card Image</div>
                    <div className='py-1 px-3'>Pan Card</div>
                    <div className='py-1 px-3'>Passport Card</div>
                    <div className='py-1 px-3'>Voter ID</div>
                    <div className='py-1 px-3'>Signed NDA</div>
                    <div className='py-1 px-3'>Background Veryficaton</div>
                </div>
                <div className="space-y-3">
                    <div className=' lg:flex hidden'>  <button className='bg-blue-600  hover:bg-blue-700 cursor-pointer text-white rounded py-1 px-3'>Upload CSV</button></div>
                    <div className=' lg:flex hidden'>  <button className='bg-blue-600  hover:bg-blue-700 cursor-pointer text-white rounded py-1 px-3'>Upload Image</button></div>
                    <div className=' lg:flex hidden'>  <button className='bg-blue-600  hover:bg-blue-700 cursor-pointer text-white rounded py-1 px-3'>Upload Image</button></div>
                    <div className=' lg:flex hidden'>  <button className='bg-blue-600  hover:bg-blue-700 cursor-pointer text-white rounded py-1 px-3'>Upload Image</button></div>
                    <div className=' lg:flex hidden'> <button className='bg-blue-600  hover:bg-blue-700 cursor-pointer text-white rounded py-1 px-3'>Upload Image</button></div>
                    <div className=' lg:flex hidden'> <button className='bg-blue-600  hover:bg-blue-700 cursor-pointer text-white rounded py-1 px-3'>Upload </button></div>
                    <div className=' lg:flex hidden'>  <button className='bg-blue-600  hover:bg-blue-700 cursor-pointer text-white rounded py-1 px-3'>Upload </button></div>
                </div>
            </div>
            <div className=' justify-center lg:hidden flex'><button className='bg-blue-600 w-full hover:bg-blue-700 cursor-pointer text-white rounded py-1 px-3'><Link to={'/factory/newpages'}>Submit</Link></button></div>
                <div className='justify-end lg:flex hidden'><button className='bg-blue-600  hover:bg-blue-700 cursor-pointer text-white rounded py-1 px-3'><Link to={'/factory/newpages'}>Submit</Link></button></div>
        </div>
