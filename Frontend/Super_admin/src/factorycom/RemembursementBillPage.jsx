...
export default function RemembursementBillPage2() {
    return (
        <div className="p-2 bg-gray-100 min-h-screen flex justify-center">
            <div className="bg-white shadow-lg rounded-2xl p-6 w-full lg:w-[800px]">
                <div className="flex justify-between items-center">
                    <h2 className="text-2xl font-semibold mb-4 text-gray-800">Reimbursement</h2>
                    <span><button className='bg-gray-300 md:px-3 px-1 py-1 rounded hover:bg-gray-200 cursor-pointer mb-4 whitespace-nowrap'><Link to={"/remembursementflexi"}>View Page</Link></button></span>
                </div>

                <div className="mb-6">
                    <div className="flex justify-between items-center">
                        <h3 className="text-xl font-medium text-green-600 mb-2">Flexible Components</h3>
                        <span>
                ...
                <div className="mb-6">
                    <h3 className="text-xl font-medium text-blue-600 mb-2">Tax Efficiency</h3>
                    <ul className="space-y-2">
                        ...
                        <li className="flex justify-between p-3 bg-blue-50 rounded-lg">
                            <span>Meal Coupons Tax-Free Limit</span>
                ...
                <div className="mt-6 border-t pt-4">
                    <div className="flex justify-between text-lg font-semibold">
                        ...
                        <span className="text-green-600">रु 33,000</span>
                    </div>
                    <div className="flex justify-between text-lg font-semibold mt-2">
                        <span>Tax-Free Component</span>
                        <span className="text-blue-600">रु 7,000</span>
                    </div>
                    <div className="flex justify-between text-lg font-semibold mt-2">
                        <span>Taxable Amount</span>
                        <span className="text-red-600">रु 26,000</span>
                    </div>
                </div>
            </div>
        </div>
