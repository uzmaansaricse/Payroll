...
export default function AdminDashboard1({ closeSidebar }) {
            ...
            ${active === "aalag" ? "text-orange-600 border-l-2 border-orange-600 rounded" : ""}`}
                ...
                <div className="rounded-lg">
                    ...
                    <div className={`flex flex-col gap-3 border-s rounded overflow-hidden transition-all duration-300 ease-in-out ${openMenu === "reports" ? "h-auto opacity-100" : "max-h-0 opacity-0"}`}>
                        ...
                        <Link to="/factory/report/ctc-structure" className="w-full" onClick={closeSidebar}>
                        ...
                        <Link to="/factory/report/payments-deductions" className="w-full" onClick={closeSidebar}>
                        ...
                        <Link to="/factory/report/tax-computation" className="w-full" onClick={closeSidebar}>
                        ...
                        <Link to="/factory/report/reimbursement" className="w-full" onClick={closeSidebar}>
                        ...
                        <Link to="/factory/report/flexi" className="w-full" onClick={closeSidebar}>
                        ...
                        <Link to="/factory/report/lic-deductions" className="w-full" onClick={closeSidebar}>
                        ...
                        <Link to="/factory/report/investments" className="w-full" onClick={closeSidebar}>
                        ...
                        <Link to="/factory/report/payroll-calculation" className="w-full" onClick={closeSidebar}>
                        ...
                        <Link to="/factory/report/attendance" className="w-full" onClick={closeSidebar}>
                        ...
                        <Link to="/factory/report/leave" className="w-full" onClick={closeSidebar}>
                        ...
                        <Link to="/factory/report/overtime" className="w-full" onClick={closeSidebar}>
