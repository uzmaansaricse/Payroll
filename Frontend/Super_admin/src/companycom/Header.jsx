    ...
    return (
        <div className="space-y-1 overflow-y-auto h-full">
            ...
            <div className="rounded-lg">
                ...
                >
                    <span onClick={() => { setActive("twot"), setOpen(false) }} className={`${active == "twot" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
                        <Link to="/admindashboard/add" className=" w-full pl-5 text-left" onClick={closeSidebar}>
                            Add Employee
                        </Link>
                    </span>
                    <span onClick={() => { setActive("onon"), setOpen(false) }} className={`${active == "onon" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
            ...
            <div className="rounded-lg">
                ...
                >
                    <span onClick={() => { setActive("twott"), setOpen(false) }} className={`${active == "twott" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
            ...
            <div className="rounded-lg">
                ...
                >
                    ...
                    <Link to="/admindashboard/personaldetailtable" className="w-full" onClick={closeSidebar}>
                        <span
                            onClick={() => { setActive("two"), setOpen(false) }}
                    ...
                    <Link to="/admindashboard/ctcstracture" className="w-full" onClick={closeSidebar}>
                        <span
                            onClick={() => { setActive("three"), setOpen(false) }}
                            className={`pl-5 text-left block w-full 
                    ...
                    <Link to="/admindashboard/paymentsdeductions" className="w-full" onClick={closeSidebar}>
                        <span
                            onClick={() => { setActive("four"), setOpen(false) }}
                            className={`pl-5 text-left block w-full 
                    ...
                    <Link to="/admindashboard/perquisitesinvestment" className="w-full" onClick={closeSidebar}>
                        <span
                            onClick={() => { setActive("five"), setOpen(false) }}
                            className={`pl-5 text-left block w-full 
                    ...
                    <Link to="/admindashboard/taxcomputation" className="w-full" onClick={closeSidebar}>
                        <span
                            onClick={() => { setActive("six"), setOpen(false) }}
                            className={`pl-5 text-left block w-full 
                    ...
                    <Link to="/admindashboard/remembursementflexi" className="w-full" onClick={closeSidebar}>
                        <span
                            onClick={() => { setActive("seven"), setOpen(false) }}
                            className={`pl-5 text-left block w-full 
                    ...
                    <Link to="/admindashboard/flexi" className="w-full" onClick={closeSidebar}>
                        <span
                            onClick={() => { setActive("alag"), setOpen(false) }}
                            className={`pl-5 text-left block w-full 
                    ...
                    <Link to="/admindashboard/taxcomputationsheet" className="w-full" onClick={closeSidebar}>
                        <span
                            onClick={() => { setActive("Deductions"), setOpen(false) }}
                            className={`pl-5 text-left block w-full 
                    ...
                    <Link to="/admindashboard/investments" className="w-full" onClick={closeSidebar}>
                        <span
                            onClick={() => { setActive("Investments"), setOpen(false) }}
                    ...
                    <Link to="/admindashboard/payrollcalculation" className="w-full" onClick={closeSidebar}>
                        <span
                            onClick={() => { setActive("aalag"), setOpen(false) }}
                            className={`pl-5 text-left block w-full 
                ...
                >
                    <div className="overflow-y-scroll">
                        ...
                        <div className={` flex flex-col gap-3 border-s rounded overflow-hidden transition-all duration-300 ease-in-out ${openMenu1 === "leave1" ? "max-h-70 opacity-100" : "max-h-0 opacity-0"}`}>
                            <span onClick={() => { setActive("twentyy101"), setOpen(false) }} className={`${active == "twentyy101" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
                                <Link to="/admindashboard/shiftmanagement" className=" w-full pl-5 text-left" onClick={closeSidebar}>
                                    Shift Management
                                </Link>
                            </span>
                            <span onClick={() => { setActive("twentyy10"), setOpen(false) }} className={`${active == "twentyy10" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
                                <Link to="/admindashboard/shiftassign" className=" w-full pl-5 text-left" onClick={closeSidebar}>
                                    Shift Assign
                                </Link>
                            </span>
                            <span onClick={() => { setActive("twentyy100"), setOpen(false) }} className={`${active == "twentyy100" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
                                <Link to="/admindashboard/TaxComputationAllinpage" className=" w-full pl-5 text-left" onClick={closeSidebar}>
                                    Attendance Assign
                                </Link>
                            </span>
                            <span onClick={() => { setActive("twentyy11"), setOpen(false) }} className={`${active == "twentyy11" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
                                <Link to="/admindashboard/workingdays" className=" w-full pl-5 text-left" onClick={closeSidebar}>
                                    Working Days
                                </Link>
                            </span>

                            <span onClick={() => { setActive("twentyy13"), setOpen(false) }} className={`${active == "twentyy13" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
                                <Link to="/admindashboard/haffdaypolicy" className=" w-full pl-5 text-left" onClick={closeSidebar}>
                                    Half Day Policy
                                </Link>
                            </span>
                            <span onClick={() => { setActive("twentyy14"), setOpen(false) }} className={`${active == "twentyy14" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
                                <Link to="/admindashboard/latearrival" className=" w-full pl-5 text-left" onClick={closeSidebar}>
                                    Late Arrival
                                </Link>
                            </span>
                            <span onClick={() => { setActive("twentyy15"), setOpen(false) }} className={`${active == "twentyy15" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
                    ...
                    <div>
                        ...
                        <div className={` flex flex-col gap-3 border-s rounded overflow-hidden transition-all duration-300 ease-in-out ${openMenu1 === "leave2" ? "max-h-70 opacity-100" : "max-h-0 opacity-0"}`}>
                            <span onClick={() => { setActive("twentyyy4"), setOpen(false) }} className={`${active == "twentyyy4" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
                            ...
                            <span onClick={() => { setActive("twentyyy5"), setOpen(false) }} className={`${active == "twentyyy5" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
                                <Link to="/admindashboard/leaveapproval" className=" w-full pl-5 text-left" onClick={closeSidebar}>
                                    Leave Approval
                                </Link>
                            </span>
                            <span onClick={() => { setActive("twentyyy55"), setOpen(false) }} className={`${active == "twentyyy55" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
                    ...
                    <div>
                        ...
                        <div className={` flex flex-col gap-3 border-s rounded overflow-hidden transition-all duration-300 ease-in-out ${openMenu1 === "leave3" ? "max-h-70 opacity-100" : "max-h-0 opacity-0"}`}>
                            <span onClick={() => { setActive("twentyyy2"), setOpen(false) }} className={`${active == "twentyyy2" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
                                <Link to="/admindashboard/role" className=" w-full pl-5 text-left" onClick={closeSidebar}>
                                    Rule
                                </Link>
                            </span>
                            <span onClick={() => {setActive("twentyyy1"),setOpen(false)}} className={`${active == "twentyyy1" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
            ...
            <div className="rounded-lg">
                ...
                <div className={` flex flex-col gap-3 border-s rounded overflow-hidden transition-all duration-300 ease-in-out ${openMenu === "Policies1" ? "max-h-70 opacity-100" : "max-h-0 opacity-0"
                    ...
                    <span onClick={() => {setActive("ten1"),setOpen(false)}} className={`${active == "ten1" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
            ...
            <div className="rounded-lg">
                ...
                <div className={` flex flex-col gap-3 border-s rounded overflow-hidden transition-all duration-300 ease-in-out ${openMenu === "boarding" ? "max-h-70 opacity-100" : "max-h-0 opacity-0"
                    ...
                    <span onClick={() => {setActive("ten"),setOpen(false)}} className={`${active == "ten" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
            ...
            <div className="rounded-lg">
                ...
                <div className={` flex flex-col gap-3 border-s rounded overflow-hidden transition-all duration-300 ease-in-out ${openMenu === "exit" ? "max-h-70 opacity-100" : "max-h-0 opacity-0"
                    ...
                    <span onClick={() => {setActive("elevenw"),setOpen(false)}} className={`${active == "elevenw" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
                        <Link to="/admindashboard/FlexiTab" className=" w-full pl-5 text-left" onClick={closeSidebar}>Resignation Setup</Link>
                    </span>
                    <span onClick={() => {setActive("eleven"),setOpen(false)}} className={`${active == "eleven" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
            ...
            <div className="rounded-lg">
                ...
                <div className={` flex flex-col gap-3 border-s rounded overflow-hidden transition-all duration-300 ease-in-out ${openMenu === "performence" ? "max-h-70 opacity-100" : "max-h-0 opacity-0"
                    ...
                    <span onClick={() => {setActive("twel"),setOpen(false)}} className={`${active == "twel" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} `}>
            ...
            <div className={`flex flex-col gap-3 border-s rounded overflow-hidden transition-all duration-300 ease-in-out ${openMenu === "reports" ? "h-auto opacity-100" : "max-h-0 opacity-0"}`}>
                <Link to="/admindashboard/employmaster" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep1"),setOpen(false)}} className={`${active === "rep1" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>Employee Master Report</span>
                </Link>
                <Link to="/admindashboard/report/ctc-structure" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep2"),setOpen(false)}} className={`${active === "rep2" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>CTC Structure Report</span>
                </Link>
                <Link to="/admindashboard/report/payments-deductions" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep3"),setOpen(false)}} className={`${active === "rep3" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>Payments & Deductions Report</span>
                </Link>
                <Link to="/admindashboard/declaration" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep44"),setOpen(false)}} className={`${active === "rep44" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>Declaration</span>
                </Link>
                <Link to="/admindashboard/actuals" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep4"),setOpen(false)}} className={`${active === "rep4" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>Actuals</span>
                </Link>
                <Link to="/admindashboard/report/tax-computation" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep5"),setOpen(false)}} className={`${active === "rep5" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>Tax Computation Report</span>
                </Link>
                <Link to="/admindashboard/report/reimbursement" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep6"),setOpen(false)}} className={`${active === "rep6" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>Reimbursement Report</span>
                </Link>
                <Link to="/admindashboard/report/flexi" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep7"),setOpen(false)}} className={`${active === "rep7" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>Flexi Report</span>
                </Link>
                <Link to="/admindashboard/report/lic-deductions" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep8"),setOpen(false)}} className={`${active === "rep8" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>LIC / Credit Society Deductions</span>
                </Link>
                <Link to="/admindashboard/report/investments" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep9"),setOpen(false)}} className={`${active === "rep9" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>Investments Report</span>
                </Link>
                <Link to="/admindashboard/report/payroll-calculation" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep10"),setOpen(false)}} className={`${active === "rep10" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>Payroll Calculation Report</span>
                </Link>
                <Link to="/admindashboard/report/attendance" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep11"),setOpen(false)}} className={`${active === "rep11" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>Attendance Report</span>
                </Link>
                <Link to="/admindashboard/report/leave" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep12"),setOpen(false)}} className={`${active === "rep12" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>Leave Report</span>
                </Link>
                <Link to="/admindashboard/report/overtime" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep13"),setOpen(false)}} className={`${active === "rep13" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>Overtime Report</span>
                </Link>
                <Link to="/admindashboard/individual" className="w-full" onClick={closeSidebar}>
                    <span onClick={() => {setActive("rep14"),setOpen(false)}} className={`${active === "rep13" ? "text-orange-600 border-s-2 border-orange-600 rounded" : ""} pl-5 text-left block`}>Individual</span>
                </Link>
            </div>
