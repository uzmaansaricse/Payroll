...
const AttendanceAssign = () => {
  ...
  const handleSubmit = () => {
    if (!selectedEmployees.length || !assignedHR || !assignedManager || (userRole !== 'superAdmin' && !attendanceRequest)) {
    ...
    const request = {
      ...
      managerAssigned: assignedManager,
  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="my-4">
        <label className="block mb-2">Assign Manager</label>
        <select
