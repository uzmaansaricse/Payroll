                    ...
                    <table className="w-full overflow-auto">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="border border-gray-200 text-[10px] md:text-[16px] p-1 md:p-2 text-center"><button className=" cursor-pointer md:px-3 px-2 py-1 rounded font-bold  "><Link to={"/editpage"}><FaEdit /></Link></button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
